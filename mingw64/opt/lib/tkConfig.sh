...
# installed.
TK_PREFIX='/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/mingw64/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/mingw64/opt'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/build/tk8.6.8/win -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/mingw64/opt/lib -ltk86'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/build/tk8.6.8/win -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/mingw64/opt/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/build/tk8.6.8/win/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/c/mingw810/x86_64-810-posix-seh-rt_v6-rev0/mingw64/opt/lib/libtkstub86.a'
