...
# build directory.
TK_BUILD_LIB_SPEC='-Wl,/clang64/lib/libtk86.dll.a'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/clang64/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/clang64/include/tk8.6/tk-private'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-Wl,/clang64/lib/libtkstub86.a'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/clang64/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/clang64/lib/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/clang64/lib/libtkstub86.a'
# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TK_INCLUDE_SPEC='-I/clang64/include/tk8.6'
