...
# build directory.
itcl_BUILD_LIB_SPEC='-L/clang64/lib/itcl4.2.2 -litcl422'
ITCL_BUILD_LIB_SPEC='-L/clang64/lib/itcl4.2.2 -litcl422'

# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-LD:/a/msys64/clang64/lib/itcl4.2.2 -litcl422'
ITCL_LIB_SPEC='-LD:/a/msys64/clang64/lib/itcl4.2.2 -litcl422'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L/clang64/lib/itcl4.2.2 -litclstub422'
ITCL_BUILD_STUB_LIB_SPEC='-L/clang64/lib/itcl4.2.2 -litclstub422'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-LD:/a/msys64/clang64/lib/itcl4.2.2 -litclstub422'
ITCL_STUB_LIB_SPEC='-LD:/a/msys64/clang64/lib/itcl4.2.2 -litclstub422'

# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='/clang64/lib/itcl4.2.2/libitclstub422.a'
ITCL_BUILD_STUB_LIB_PATH='/clang64/lib/itcl4.2.2/libitclstub422.a'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='D:/a/msys64/clang64/lib/itcl4.2.2/libitclstub422.a'
ITCL_STUB_LIB_PATH='D:/a/msys64/clang64/lib/itcl4.2.2/libitclstub422.a'
