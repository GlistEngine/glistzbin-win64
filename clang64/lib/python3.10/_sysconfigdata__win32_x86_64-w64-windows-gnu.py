...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/clang64/bin',
 'BINLIBDEST': '/clang64/lib/python3.10',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -march=nocona -msahf -mtune=generic -O2 -pipe '
 ...
 'CONFINCLUDEDIR': '/clang64/include',
 'CONFINCLUDEPY': '/clang64/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/c/M/mingw-w64-python/src/build-CLANG64/coverage.info',
 'COVERAGE_REPORT': '/c/M/mingw-w64-python/src/build-CLANG64/lcov-report',
 ...
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/clang64 /clang64/lib /clang64/lib/python3.10 '
             '/clang64/lib/python3.10/lib-dynload',
 'DESTLIB': '/clang64/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/clang64/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cp310-mingw_x86_64_clang.pyd',
 'FILEMODE': 644,
 ...
 'INCLDIRSTOMAKE': '/clang64/include /clang64/include '
                   '/clang64/include/python3.10 /clang64/include/python3.10',
 'INCLUDEDIR': '/clang64/include',
 'INCLUDEPY': '/clang64/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/clang64/lib/python3.10',
 'LIBDIR': '/clang64/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/clang64/lib/pkgconfig',
 'LIBPL': '/clang64/lib/python3.10/config-3.10',
 ...
 'LLVM_PROF_MERGER': '/clang64/bin/llvm-profdata merge -output=code.profclangd '
                     '*.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '-lws2_32',
 'MACHDEP': 'win32',
 'MACHDEP_OBJS': 'PC/dl_nt.o',
 'MACHDESTLIB': '/clang64/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Python-3.10.9/Modules/makesetup',
 'MANDIR': '/clang64/share/man',
 ...
 'NCURSESW_INCLUDEDIR': 'D:/a/msys64/clang64/include/ncursesw',
 'NO_AS_NEEDED': '',
 'NT_THREADS': 1,
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -march=nocona -msahf -mtune=generic -O2 '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf '
                   ...
                   '-DPY3_DLLNAME=\'L"libpython3.10.dll"\' '
                   '-DMS_DLL_ID=\'"3.10"\' -fprofile-instr-use=code.profclangd '
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/clang64/share/zoneinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': '../Python-3.10.9/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'VENVLAUNCHERDIR': '/clang64/lib/python3.10/venv/scripts/nt',
 'VERSION': '3.10',
 ...
 'abs_builddir': 'C:/M/mingw-w64-python/src/build-CLANG64',
 'abs_builddir_b2h': 'C:/M/mingw-w64-python/src/build-CLANG64',
 'abs_srcdir': 'C:/M/mingw-w64-python/src/Python-3.10.9',
 'abs_srcdir_b2h': 'C:/M/mingw-w64-python/src/Python-3.10.9',
 'datarootdir': '/clang64/share',
 'exec_prefix': '/clang64',
 'prefix': 'D:/a/msys64/clang64',
 'prefix_b2h': 'D:/a/msys64/clang64',
